...
const TOPIC_METADATA = {
  ...
  'Instructions: Actions': { icon: 'BookOpen', color: 'sky', emoji: '📖' },
  'Norādījumi: darbības': { icon: 'BookOpen', color: 'sky', emoji: '📖' },
  'Инструкции: действия': { icon: 'BookOpen', color: 'sky', emoji: '📖' },
  'Instructions: Games & Art': { icon: 'Palette', color: 'pink', emoji: '🎨' },
  'Norādījumi: spēles un māksla': { icon: 'Palette', color: 'pink', emoji: '🎨' },
  'Инструкции: игры и творчество': { icon: 'Palette', color: 'pink', emoji: '🎨' },
  'Instructions: Logic & Numbers': { icon: 'Shapes', color: 'amber', emoji: '🔢' },
  'Norādījumi: loģika un skaitīšana': { icon: 'Shapes', color: 'amber', emoji: '🔢' },
  'Инструкции: логика и счёт': { icon: 'Shapes', color: 'amber', emoji: '🔢' },
  'Instructions: Teamwork & Practice': { icon: 'Users', color: 'emerald', emoji: '🤝' },
  'Norādījumi: darbs klasē': { icon: 'Users', color: 'emerald', emoji: '🤝' },
  'Инструкции: работа в классе': { icon: 'Users', color: 'emerald', emoji: '🤝' },
  'Prepositions and place': { icon: 'Compass', color: 'blue', emoji: '🧭' },
  'Prievārdi un vieta': { icon: 'Compass', color: 'blue', emoji: '🧭' },
  'Предлоги и место': { icon: 'Compass', color: 'blue', emoji: '🧭' },
  'Connecting words': { icon: 'Sparkles', color: 'purple', emoji: '🔗' },
  'Loģika un daudzums': { icon: 'Sparkles', color: 'purple', emoji: '🔗' },
  'Логика и количество': { icon: 'Sparkles', color: 'purple', emoji: '🔗' },
  'School materials': { icon: 'Scissors', color: 'amber', emoji: '✂️' },
  'Mācību materiāli': { icon: 'Scissors', color: 'amber', emoji: '✂️' },
  'Материалы для уроков': { icon: 'Scissors', color: 'amber', emoji: '✂️' },
  'Skolas materiāli': { icon: 'Scissors', color: 'amber', emoji: '✂️' },
  'Школьные материалы': { icon: 'Scissors', color: 'amber', emoji: '✂️' },
  'School and lessons': { icon: 'School', color: 'teal', emoji: '🏫' },
  'Skola un stundas': { icon: 'School', color: 'teal', emoji: '🏫' },
  'Школа и уроки': { icon: 'School', color: 'teal', emoji: '🏫' },
