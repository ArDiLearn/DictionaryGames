...
const TOPIC_METADATA = {
  ...
  'Craft and projects': { icon: 'Scissors', color: 'purple', emoji: '🎨' },
  'Darbiņi un projekti': { icon: 'Scissors', color: 'purple', emoji: '🎨' },
  'Творчество и проекты': { icon: 'Scissors', color: 'purple', emoji: '🎨' },
